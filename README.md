...
| 19 | Standard utilities (CLI-OS parity — usability, not the thesis) | ✅ Done and extended — ~35 separately loaded programs (files, text, system), a full-screen editor with undo/find/replace/clipboard, directories, pipes and redirection, a host file bridge; see `docs/USER_GUIDE.md` |
